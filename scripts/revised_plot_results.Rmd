...
ggsave(
  "../revised_plots/gene/gene_main_fp.pdf",
  gene_main_fp,
  width = 20,
  height = 15,
  units = "cm"
...
gene_main_tp <- bgr_nz10 %>%
  ...
  bind_rows(
    data.frame(
      ...
      predictor_cor = c("No", "No"), cov_str = c("scalar", "unstructured")
    )
  ) %>%
...
ggsave( 
  "../revised_plots/gene/gene_main_tp.pdf",
  gene_main_tp,
  width = 20,
  height = 15,
  units = "cm"
...
ggsave("../revised_plots/gene/gene_main_select.pdf", width = 40, height = 15, units = "cm")
```
...
gene_supp_nz5_fp
ggsave(
    "../revised_plots/gene/gene_supp_nz5_fp.pdf",
    gene_supp_nz5_fp,
    width = 15,
    height = 15,
    units = "cm"
...
gene_supp_nz5_tp
ggsave(
    "../revised_plots/gene/gene_supp_nz5_tp.pdf",
    gene_supp_nz5_tp,
    width = 15,
    height = 15,
    units = "cm"
...
#Note that there are fewer than 100 data-sets for some of the lasso settings (but none of the scad settings)!
ggsave(
  "../revised_plots/gene/gene_supp_nz10_fp.pdf",
  gene_supp_nz10_fp,
  width = 15,
  height = 15,
  units = "cm"
...
#Note that there are fewer than 100 data-sets for some of the lasso settings (but none of the scad settings)!
ggsave(
  "../revised_plots/gene/gene_supp_nz10_tp.pdf",
  gene_supp_nz10_tp,
  width = 15,
  height = 15,
  units = "cm"
...
ggsave("../revised_plots/gene/gene_supp_select.pdf", width = 40, height = 30, units = "cm")
```
...
#Note that there are fewer than 100 data-sets for some of the lasso settings (but none of the scad settings)!
ggsave(
  "../revised_plots/gene/gene_main_beta2.pdf",
  gene_main_beta2,
  width = 20,
  height = 15,
  units = "cm"
...
#Note that there are fewer than 100 data-sets for some of the lasso settings (but none of the scad settings)!
ggsave(
  "../revised_plots/gene/gene_main_beta3.pdf",
  gene_main_beta3,
  width = 20,
  height = 15,
  units = "cm"
...
gene_main_beta8
ggsave(
  "../revised_plots/gene/gene_main_beta8.pdf",
  gene_main_beta8,
  width = 20,
  height = 15,
  units = "cm"
...
ggsave("../revised_plots/gene/gene_main_est.pdf", width = 40, height = 15, units = "cm")
```
...
#Note that there are fewer than 100 data-sets for some of the lasso settings (but none of the scad settings)!
ggsave(
  "../revised_plots/gene/gene_supp_beta3.pdf",
  gene_supp_beta3,
  width = 15,
  height = 15,
  units = "cm"
...
gene_supp_nz5_beta3
ggsave(
    "../revised_plots/gene/gene_supp_nz5_beta3.pdf",
    gene_supp_nz5_beta3,
    width = 15,
    height = 15,
    units = "cm"
...
ggsave("../revised_plots/gene/gene_supp_est.pdf", width = 40, height = 30, units = "cm")
```
...
ggsave(
  "../revised_plots/gene/var_ge_scalar.pdf",
  var_ge_scalar,
  width = 20,
  height = 15,
  units = "cm"
...
ggsave(
  "../revised_plots/gene/var_ge_diag.pdf",
  var_ge_diag,
  width = 20,
  height = 15,
  units = "cm"
...
var_ge_sym
ggsave(
  "../revised_plots/gene/var_ge_sym.pdf",
  var_ge_sym,
  width = 20,
  height = 15,
  units = "cm"
...
ggsave("../revised_plots/gene/var_ge_comp.pdf", width = 40, height = 30, units = "cm")
```
...
ggsave(
  "../revised_plots/gwas/gwas_main_fp.pdf",
  gwas_main_fp,
  width = 20,
  height = 8,
  units = "cm"
...
ggsave(
  "../revised_plots/gwas/gwas_main_tp.pdf",
  gwas_main_fp,
  width = 20,
  height = 8,
  units = "cm"
...
ggsave("../revised_plots/gwas/gwas_main_select.pdf", width = 40, height = 10, units = "cm")
```
...
ggsave(
  "../revised_plots/gwas/gwas_supp_fp.pdf",
  gwas_main_fp,
  width = 20,
  height = 8,
  units = "cm"
...
ggsave(
  "../revised_plots/gwas/gwas_supp_tp.pdf",
  gwas_supp_tp,
  width = 20,
  height = 8,
  units = "cm"
...
ggsave("../revised_plots/gwas/gwas_supp_select.pdf", width = 40, height = 10, units = "cm")
```
...
#Note that there are fewer than 100 data-sets for some of the lasso settings (but none of the scad settings)!
ggsave(
  "../revised_plots/gwas/gwas_main_beta3.pdf",
  gwas_main_beta3,
  width = 20,
  height = 8,
  units = "cm"
...
#Note that there are fewer than 100 data-sets for some of the lasso settings (but none of the scad settings)!
ggsave(
  "../revised_plots/gwas/gwas_main_beta8.pdf",
  gwas_main_beta8,
  width = 20,
  height = 8,
  units = "cm"
...
ggsave("../revised_plots/gwas/gwas_main_est.pdf", width = 40, height = 10, units = "cm")
...
#Note that there are fewer than 100 data-sets for some of the lasso settings (but none of the scad settings)!
ggsave(
  "../revised_plots/gwas/gwas_supp_beta3.pdf",
  gwas_supp_beta3,
  width = 20,
  height = 8,
  units = "cm"
...
#Note that there are fewer than 100 data-sets for some of the lasso settings (but none of the scad settings)!
ggsave(
  "../revised_plots/gwas/gwas_supp_beta8.pdf",
  gwas_supp_beta8,
  width = 20,
  height = 8,
  units = "cm"
...
ggsave("../revised_plots/gwas/gwas_supp_est.pdf", width = 40, height = 10, units = "cm")
...
ggsave(
  "../revised_plots/gwas/var_gwas_scalar.pdf",
  var_gwas_scalar,
  width = 20,
  height = 15,
  units = "cm"
...
ggsave(
  "../revised_plots/gwas/var_gwas_diag.pdf",
  var_gwas_diag,
  width = 20,
  height = 15,
  units = "cm"
...
ggsave(
  "../revised_plots/gwas/var_gwas_sym.pdf",
  var_gwas_sym,
  width = 20,
  height = 15,
  units = "cm"
...
ggsave("../revised_plots/gwas/var_gwas_comp.pdf", width = 40, height = 30, units = "cm")
```
...
otu_main_fp <- best_otu_results  %>%
  ...
  theme(legend.position = "none",
        ...
        text = element_text(size = 18)) +
  scale_y_continuous(expand = expansion(mult = c(0, .05))) +
  scale_color_manual(values = "#BEAED4", labels = "SCAD", breaks = "scad")
  }

otu_main_fp
ggsave(
  "../revised_plots/otu/otu_main_fp.pdf",
  otu_main_fp,
  width = 20,
  height = 10,
  units = "cm"
...
ggsave(
  "../revised_plots/otu/otu_main_tp.pdf",
  gwas_main_fp,
  width = 20,
  height = 10,
  units = "cm"
...
ggsave("../revised_plots/otu/otus_main_select.pdf", width = 40, height = 10, units = "cm")
...
otu_supp_fp_bsf <- best_otu_results  %>%
  ...
  mutate(outlier = fp > quantile(fp, .75) + IQR(fp) * 1.5) %>%
  ungroup() %>% {
    ggplot(data = ., aes(y = fp/117, x = q, col = penalty)) +
      geom_boxplot(width = .3, outlier.shape = NA, show.legend = F) +
      geom_point(data = filter(., outlier), 
                 pch = 21, #aes(alpha = plot),
                 position = position_jitter(height = 0, width = 0.1)) +
...
otu_supp_fp_bsf
ggsave(
  "../revised_plots/otu/otu_supp_fp_bsf.pdf",
  otu_supp_fp_bsf,
  width = 20,
  height = 10,
  units = "cm"
...
otu_supp_fp_others <- best_otu_results  %>%
  ...
  theme(legend.position = "none",
        ...
        text = element_text(size = 18)) +
  scale_color_manual(values = "#BEAED4", labels = "SCAD", breaks = "scad") +
  scale_y_continuous(n.breaks = 4, expand = expansion(mult = c(0, .05)))
  }

otu_supp_fp_others
ggsave(
  "../revised_plots/otu/otu_supp_fp_others.pdf",
  otu_supp_fp_bsf,
  width = 20,
  height = 10,
  units = "cm"
...
otu_supp_tp_bsf <- best_otu_results  %>%
  ...
  geom_text(data = counts, aes(q, 11, label = cnt_perfect),
            show.legend = FALSE, size = 5) +
  facet_wrap(~ otu_cor, nrow = 2) +
  labs(y = "# true positives (out of 11)", x = TeX("# random effects ($q$)")) + 
  scale_y_continuous(labels = scales::label_number(accuracy = 1), 
...
otu_supp_tp_bsf
ggsave(
  "../revised_plots/otu/otu_supp_tp_bsf.pdf",
  otu_supp_fp_bsf,
  width = 20,
  height = 10,
  units = "cm"
...
otu_supp_tp_others
ggsave(
  "../revised_plots/otu/otu_supp_tp_others.pdf",
  otu_supp_fp_bsf,
  width = 20,
  height = 10,
  units = "cm"
...
ggsave("../revised_plots/otu/otu_supp_select_bsf.pdf", width = 40, height = 15, units = "cm")
```


```{r}
otu_supp_fp_others + otu_supp_tp_others + plot_layout(guides = "collect") + plot_annotation(tag_levels = 'A')
ggsave("../revised_plots/otu/otu_supp_select_others.pdf", width = 40, height = 15, units = "cm")
```
...
First, let's look at the coefficient on the group-level measured variable:
...
ggsave(
  "../revised_plots/otu/otu_main_betagrp.pdf",
  otu_main_betagrp,
  width = 20,
  height = 10,
  units = "cm"
...
```
Now an unpenalized coefficient
```{r}
df_true <- data.frame(y_value = -3)
otu_main_beta8 <- best_otu_results %>%
  filter(q==3, otu_cor %in% c("band", "scale_free")) %>%
  group_by(otu_cor, cov_str) %>%
  mutate(outlier = beta_9 > quantile(beta_9, .75) + IQR(beta_9) * 1.5 | 
           beta_9 < quantile(beta_9, .25) - IQR(beta_9) * 1.5) %>%
  ungroup() %>%
  {
  ggplot(data =., aes(y = beta_9, x = cov_str, 
                      col = penalty)) +
  geom_boxplot(position = position_dodge(width = 0.9), 
               outlier.shape = NA) +
  geom_point(data = filter(., outlier), 
...
```
```{r}
otu_main_betagrp + otu_main_beta8 + plot_layout(guides = "collect") + plot_annotation(tag_levels = 'A') 
ggsave("../revised_plots/otu/otu_main_est.pdf", width = 40, height = 15, units = "cm")
```
...
ggsave(
  "../revised_plots/otu/otu_supp_betagrp_bsf.pdf",
  otu_supp_betagrp_bsf,
  width = 20,
  height = 10,
  units = "cm"
...
ggsave(
  "../revised_plots/otu/otu_supp_betagrp_other.pdf",
  otu_supp_betagrp_other,
  width = 20,
  height = 10,
  units = "cm"
...
Now let's look at $\beta_8$:

Band and scale-free:
```{r}
df_true <- data.frame(y_value = -3)
otu_supp_beta8_bsf <- best_otu_results %>%
  filter(q!=3, otu_cor %in% c("band", "scale_free")) %>%
  group_by(otu_cor, q) %>%
  mutate(outlier = beta_9 > quantile(beta_9, .75) + IQR(beta_9) * 1.5 | 
           beta_9 < quantile(beta_9, .25) - IQR(beta_9) * 1.5) %>%
...
ggsave(
  "../revised_plots/otu/otu_supp_beta8_bsf.pdf",
  otu_supp_beta8_bsf,
  width = 20,
  height = 10,
  units = "cm"
...
```{r}
df_true <- data.frame(y_value = -3)
otu_supp_beta8_other <- best_otu_results %>%
  filter(!(otu_cor %in% c("band", "scale_free"))) %>%
  group_by(otu_cor, q, cov_str) %>%
  mutate(outlier = beta_9 > quantile(beta_9, .75) + IQR(beta_9) * 1.5 | 
           beta_9 < quantile(beta_9, .25) - IQR(beta_9) * 1.5) %>%
...
otu_supp_beta8_other

ggsave(
  "../revised_plots/otu/otu_supp_beta8_other.pdf",
  otu_supp_beta8_other,
  width = 20,
  height = 10,
  units = "cm"
...
```{r}
otu_supp_betagrp_bsf + otu_supp_beta8_bsf + plot_layout(guides = "collect") + plot_annotation(tag_levels = 'A')
ggsave("../revised_plots/otu/otu_supp_est_bsf.pdf", width = 40, height = 15, units = "cm")
```


```{r}
otu_supp_betagrp_other + otu_supp_beta8_other + plot_layout(guides = "collect") + plot_annotation(tag_levels = 'A') 
ggsave("../revised_plots/otu/otu_supp_est_others.pdf", width = 40, height = 15, units = "cm")
```
