...
```{r}
otu_main_fp + otu_main_tp + plot_layout(guides = "collect") + plot_annotation(tag_levels = 'A') & theme(legend.position = 'bottom') 
ggsave("../revised_plots/otus_main_select.pdf", width = 40, height = 10, units = "cm")
...
otu_supp_fp_bsf
ggsave(
  "../revised_plots/otu_supp_fp_bsf.pdf",
  otu_supp_fp_bsf,
  width = 20,
  height = 10,
  units = "cm"
...
otu_supp_fp_others
ggsave(
  "../revised_plots/otu_supp_fp_others.pdf",
  otu_supp_fp_bsf,
  width = 20,
  height = 10,
  units = "cm"
...
otu_supp_tp_bsf
ggsave(
  "../revised_plots/otu_supp_tp_bsf.pdf",
  otu_supp_fp_bsf,
  width = 20,
  height = 10,
  units = "cm"
...
otu_supp_tp_others
ggsave(
  "../revised_plots/otu_supp_tp_others.pdf",
  otu_supp_fp_bsf,
  width = 20,
  height = 10,
  units = "cm"
...
ggsave("../revised_plots/otu_supp_select_bsf.pdf", width = 40, height = 15, units = "cm")
```


```{r}
otu_supp_fp_others + otu_supp_tp_others + plot_layout(guides = "collect") + plot_annotation(tag_levels = 'A') & theme(legend.position = 'bottom') 
ggsave("../revised_plots/otu_supp_select_others.pdf", width = 40, height = 15, units = "cm")
```
...
ggsave(
  "../revised_plots/otu_main_betagrp.pdf",
  otu_main_betagrp,
  width = 20,
  height = 10,
  units = "cm"
...
```
```{r}
otu_main_betagrp + otu_main_beta8 + plot_layout(guides = "collect") + plot_annotation(tag_levels = 'A') & theme(legend.position = 'bottom') 
ggsave("../revised_plots/otu_main_est.pdf", width = 40, height = 15, units = "cm")
```
...
ggsave(
  "../revised_plots/otu_supp_betagrp_bsf.pdf",
  otu_supp_betagrp_bsf,
  width = 20,
  height = 10,
  units = "cm"
...
ggsave(
  "../revised_plots/otu_supp_betagrp_other.pdf",
  otu_supp_betagrp_other,
  width = 20,
  height = 10,
  units = "cm"
...
ggsave(
  "../revised_plots/otu_supp_beta8_bsf.pdf",
  otu_supp_beta8_bsf,
  width = 20,
  height = 10,
  units = "cm"
...
ggsave(
  "../revised_plots/otu_supp_beta8_other.pdf",
  otu_supp_beta8_other,
  width = 20,
  height = 10,
  units = "cm"
...
```{r}
otu_supp_betagrp_bsf + otu_supp_beta8_bsf + plot_layout(guides = "collect") + plot_annotation(tag_levels = 'A') & theme(legend.position = 'bottom') 
ggsave("../revised_plots/otu_supp_est_bsf.pdf", width = 40, height = 15, units = "cm")
```


```{r}
otu_supp_betagrp_other + otu_supp_beta8_other + plot_layout(guides = "collect") + plot_annotation(tag_levels = 'A') & theme(legend.position = 'bottom') 
ggsave("../revised_plots/otu_supp_est_others.pdf", width = 40, height = 15, units = "cm")
```
