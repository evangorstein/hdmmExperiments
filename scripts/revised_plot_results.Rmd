...
bgr_nz10 %>%
  ...
  write_csv("../true_positive_tables/gene/gene_main_tp.csv")
...
gene_main_beta4
ggsave(
  "../revised_plots/gene/gene_main_beta4.pdf",
  gene_main_beta4,
  width = 20,
  height = 15,
  units = "cm"
...
compensation
ggsave(
  "../revised_plots/gene/compensation.pdf",
  compensation,
  width = 20,
  height = 15,
  units = "cm"
...
gene_supp_nz5_beta4
ggsave(
    "../revised_plots/gene/gene_supp_nz5_beta4.pdf",
    gene_supp_nz5_beta4,
    width = 15,
    height = 15,
    units = "cm"
...
ggsave("../revised_plots/gene/gene_supp_est.pdf", width = 40, height = 40, units = "cm")
```
...
best_gwas_results %>%
  ...
  write_csv("../true_positive_tables/gwas/gwas_main_tp.csv")
...
best_otu_results %>%
  ...
  write_csv("../true_positive_tables/otu/otu_main_tp.csv")
```
