...
ggsave("../plots/gwas/gwas_main_select.eps", width = 40, height = 10, units = "cm")
```
...
ggsave("../plots/otu/otus_main_select.eps", width = 40, height = 10, units = "cm")
